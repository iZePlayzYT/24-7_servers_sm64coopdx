...
hook_chat_command("time", "\\#00ffff\\[set|add|scale|query|24h|sync]\\#dcdcdc\\ - The command handle for Day Night Cycle DX \\#7f7f7f\\(leave blank to toggle Day Night Cycle on or off)", on_time_command)
